...
<template>
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-800 dark:to-gray-900 flex-col justify-center items-center px-12">
            <div class="max-w-4xl text-center">
                <!-- Logo -->
                <div class="flex justify-center mb-8">
                    <div class="w-48 h-48 bg-white rounded-full flex items-center justify-center shadow-lg">
                        <div class="w-36 h-36 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full flex items-center justify-center">
                ...
                <!-- Brand Name -->
                <h1 class="text-xl font-bold text-gray-900 dark:text-white mb-8 handwritten" style="font-size: 8rem;">
                    DoraEdu
                </h1>
            ...
            <div class="w-full max-w-md">
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
                    <div class="text-center mb-8">
                        <h2 class="text-3xl font-bold text-gray-900 dark:text-white">Đăng nhập</h2>
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                            Đăng nhập với tài khoản <span class="font-semibold text-blue-600 dark:text-blue-400">{{ getUserTypeDisplay() }}</span>
                        </p>
                    </div>
                    ...
                    >
                        ...
                        >
                            Chưa có tài khoản?
                            <TextLink href="/register" :tabindex="6" class="text-blue-600">Đăng ký ngay</TextLink>
                        </div>
                    </Form>
                </div>
            </div>
